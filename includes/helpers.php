<?php
/**
 * Various helpers functions that exist in the global namespace. We should be OK for collisions but we'll protect ourselves from 500s.
 *
 * @package WPC
 */

if ( ! function_exists( 'get_posts_from_primary_category' ) ) {
	/**
